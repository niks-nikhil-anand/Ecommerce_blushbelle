...
const News = () => {
  ...
  return (
    <div className="flex flex-col px-4 md:px-10 mt-10 mb-10 justify-center md:ml-[20px]">
      <h2 className="text-2xl md:text-3xl lg:text-4xl mb-4 font-bold text-center underline">
