...
const FeatureHighlights = () => {
  ...
  {/* Top Wave */}
  <div className="absolute md:top-[-25px] top-[-7px] left-0 w-full">
    <Image src={topWave} alt="Top Wave" layout="responsive" objectFit="cover" priority />
  </div>

  {/* Content */}
  <div className="container mx-auto px-6 py-7 flex flex-wrap justify-center md:justify-around items-center space-y-6 md:space-y-0">
    {/* Free Shipping */}
  ...
  {/* Bottom Wave */}
  <div className="absolute md:bottom-[-30px] bottom-[-7px] left-0 w-full">
