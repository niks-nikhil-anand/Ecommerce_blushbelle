...
const GenuisKidGrid = () => {
  return (
    <div className="relative flex items-center justify-between bg-gray-50 p-8 rounded-sm shadow-lg max-w-4xl mx-auto my-10">
      {/* Background Image */}
      <div
        className="absolute top-[-100px] left-[-100px] w-[330px] h-[330px] bg-no-repeat bg-contain"
      ...
      <div className="max-w-md z-10">
        ...
        <div className="text-green-500 font-semibold text-lg mb-2">Genuis Kids</div>
