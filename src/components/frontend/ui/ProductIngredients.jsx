...
const ProductIngredients = () => {
  return (
    <div className="flex flex-col md:flex-row bg-white px-[10rem] py-10  md:items-start gap-10 justify-center items-center">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full md:w-[30rem]">
      ...
      <div className="w-full md:w-[326px] h-auto flex justify-center items-center">
        <Image src={MainBanner} height={500} width={500} alt="Main Banner" />
      </div>
    </div>
  );
};
